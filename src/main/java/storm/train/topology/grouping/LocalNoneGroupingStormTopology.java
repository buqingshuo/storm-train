 ...
 * @date 2020年2月15日
 */
public class LocalNoneGroupingStormTopology {
	...
	public static void main(String[] args) {
		...
		builder.setBolt("SumBolt", new SumBolt(), 3).noneGrouping("DataSourceSpout");

		// 创建一个本地Storm集群：本地模式运行，不需要搭建Storm集群
		LocalCluster cluster = new LocalCluster();
		cluster.submitTopology("LocalNoneGroupingStormTopology", new Config(), builder.createTopology());
	}
}
