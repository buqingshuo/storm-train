...
/**
 * 
 * 测试Partial Key grouping
 * 
 * @author buqingshuo
 * @date 2020年2月15日
 */
public class LocalPartialKeyGroupingStormTopology {
	...
	public static void main(String[] args) {
		...
		cluster.submitTopology("LocalPartialKeyGroupingStormTopology", new Config(), builder.createTopology());
	}
}
